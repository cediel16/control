...
sesiones::logged_in();
sesiones::has_permission('usuarios.roles.acceso');
?>
<!DOCTYPE html>
<html>
    <head>
                ...
                <ul>
                    ...
                    <li class="search">
                        <ul class="nav nav-pills">
                            ...
                            <li class="active"><a href="<?php echo site_url().'/usuarios/roles' ?>">Roles</a></li>
                            <li><a href="<?php echo site_url().'/usuarios/permisos' ?>">Permisos</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
